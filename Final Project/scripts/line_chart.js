...
d3.csv("data/yearly_abortion.csv").then(function (data) {
    ...
    annotate_top("Hyde Park", 1976, 24.2,200,12,1)
    ...
    annotate_top("Planned Parenthood", 2007, 19.5,125,-10,0)

    annotate_top("Whole Woman's Health", 2016, 13.7,60,-13,1)
    annotate_top("v. Hellerstedt", 2016, 13.7,45,-10,0)
